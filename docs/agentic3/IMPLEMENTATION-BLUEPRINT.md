...
Unexpected Success Record. `IER` intentionally remains the approved
three-letter stable identifier from the canonical memory taxonomy; normalizing
it to a two-letter abbreviation would break record references. Lifecycle is
